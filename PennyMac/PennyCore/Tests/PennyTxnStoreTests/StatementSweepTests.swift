...
private let sweepPins: [SweepPin] = [
    ...
    SweepPin(file: "boi_dummy_statement.pdf", inTestData: true, rows: 32,
             currency: "GBP", bank: "NOT A REAL BANK DOCUMENT",
             fullBalanceChain: false, datesMonotonic: true,
             totalDebit: 9574.54, totalCredit: 7024.5599999999995,
             first: RowPin(date: "2026-06-07", descr: "26 TRANSFER FROM SAVINGS", debit: 649.99, credit: 0, balance: 1899.99),
             last: RowPin(date: "2026-07-06", descr: "26 BALANCE CARRIED FORWARD This is a computer-generated SYNTHETIC statement crea", debit: 5804.92, credit: 0, balance: 5804.92)),
    ...
    SweepPin(file: "chase_dummy_statement.pdf", inTestData: true, rows: 32,
             currency: "USD", bank: "NOT A REAL BANK DOCUMENT",
             fullBalanceChain: false, datesMonotonic: true,
             totalDebit: 3723.080000000001, totalCredit: 8274.560000000001,
             first: RowPin(date: "2026-06-07", descr: "BEGINNING BALANCE", debit: 0, credit: 1250, balance: 0),
             last: RowPin(date: "2026-07-06", descr: "AT&T WIRELESS", debit: 129.67, credit: 0, balance: 5851.46)),
    SweepPin(file: "lloyds_dummy_statement.pdf", inTestData: true, rows: 32,
             currency: "GBP", bank: "NOT A REAL BANK DOCUMENT",
             fullBalanceChain: false, datesMonotonic: true,
             totalDebit: 7088.359999999999, totalCredit: 4390.719999999999,
             first: RowPin(date: "2026-06-07", descr: "26 REFUND - JOHN LEWIS", debit: 723.82, credit: 0, balance: 1973.82),
             last: RowPin(date: "2026-07-06", descr: "26 BALANCE CARRIED FORWARD This is a computer-generated SYNTHETIC statement crea", debit: 2621.19, credit: 0, balance: 2621.19)),
    SweepPin(file: "metrobank_dummy_statement.pdf", inTestData: true, rows: 32,
             currency: "GBP", bank: "NOT A REAL BANK DOCUMENT",
             fullBalanceChain: false, datesMonotonic: true,
             totalDebit: 9574.54, totalCredit: 7024.5599999999995,
             first: RowPin(date: "2026-06-07", descr: "26 TRANSFER FROM SAVINGS", debit: 649.99, credit: 0, balance: 1899.99),
             last: RowPin(date: "2026-07-06", descr: "26 BALANCE CARRIED FORWARD This is a computer-generated SYNTHETIC statement crea", debit: 5804.92, credit: 0, balance: 5804.92)),
    SweepPin(file: "revolut_dummy_statement.pdf", inTestData: true, rows: 32,
             currency: "GBP", bank: "Revolut Dummy",
             fullBalanceChain: false, datesMonotonic: true,
             totalDebit: 7717.07, totalCredit: 5167.09,
             first: RowPin(date: "2026-06-07", descr: "26 TOP-UP FROM BANK ACCOUNT", debit: 649.99, credit: 0, balance: 1899.99),
             last: RowPin(date: "2026-07-06", descr: "26 BALANCE CARRIED FORWARD This is a computer-generated SYNTHETIC statement crea", debit: 2467.12, credit: 0, balance: 2467.12)),
    SweepPin(file: "santander_dummy_statement.pdf", inTestData: true, rows: 32,
             currency: "GBP", bank: "NOT A REAL BANK DOCUMENT",
             fullBalanceChain: false, datesMonotonic: true,
             totalDebit: 9574.54, totalCredit: 7024.5599999999995,
             first: RowPin(date: "2026-06-07", descr: "26 TRANSFER FROM SAVINGS", debit: 649.99, credit: 0, balance: 1899.99),
    ...
    SweepPin(file: "specimen_coutts_statement.pdf", inTestData: true, rows: 32,
             ...
             fullBalanceChain: true, datesMonotonic: true,
             totalDebit: 24469.33, totalCredit: 30193.379999999997,
             first: RowPin(date: "2026-04-01", descr: "SAMPLE EMPLOYER LTD -", debit: 6663.82, credit: 0, balance: 24914.22),
    ...
    SweepPin(file: "tsb_dummy_statement.pdf", inTestData: true, rows: 32,
             currency: "GBP", bank: "NOT A REAL BANK DOCUMENT",
             fullBalanceChain: false, datesMonotonic: true,
             totalDebit: 9574.54, totalCredit: 7024.5599999999995,
             first: RowPin(date: "2026-06-07", descr: "26 TRANSFER FROM SAVINGS", debit: 649.99, credit: 0, balance: 1899.99),
